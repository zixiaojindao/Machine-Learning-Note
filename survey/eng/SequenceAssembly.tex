...
\section{About Data}
I list a typical read and its associated reference source \href{https://github.com/zixiaojindao/RNA-sequence-info/blob/master/dataset.txt}{Here}. What's more, I've downloaded mouse data and distributed the data in the `D:\textbackslash v-sunz\textbackslash assembly-data-set\textbackslash mouse.dna' directories of server srgx-01 and srgsi-81.
\section{Summary}
